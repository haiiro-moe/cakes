			...
			<section className="flex flex-col bg-base-100 border-b border-base-300 w-full">
				<div className="relative flex flex-col mx-auto mt-16 pb-16 text-left container">
					...
					<div className="links_outer">
						<div className="flex flex-wrap gap-3 links_inner">
							<RouterLink
								href="https://github.com/Kex1016"
								target="_blank"
								className="flex items-center gap-4 bg-transparent hover:bg-base-200/50 p-4 rounded-lg transition-all duration-200 ease-in-out"
							>
								<div>
									<svg
										role="img"
								...
								<div>
									...
									<div className="opacity-60 font-semibold text-xs uppercase">
										The place for questionable code!
									</div>
								</div>
							</RouterLink>
							<RouterLink
							...
							>
								...
								<div>
									<div>
										AniList:{" "}
										<span className="bg-base-200 px-2 border border-base-300 rounded-sm font-sm font-mono">
											cakes
										</span>
									</div>
									<div className="opacity-60 font-semibold text-xs uppercase">
										Dangerous amount of girls&apos; love.
									</div>
								</div>
							</RouterLink>
							<RouterLink
							...
							>
								...
								<div>
									...
									<div className="opacity-60 font-semibold text-xs uppercase">
										Probably my most frequent hangout spot.
									</div>
								</div>
							</RouterLink>
						</div>
