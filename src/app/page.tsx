	...
	return (
		<main className="flex flex-col mx-auto w-full page-transition home page-root">
			...
			<section className="flex flex-col bg-base-100 border-b border-base-300 w-full">
				<div className="mx-auto mt-16 pb-16 text-center container">
			...
			<section className="flex flex-col border-b border-base-300 w-full">
				<div className="mx-auto mt-16 pb-16 container">
					...
					<p className="mt-4 text-2xl">
						...
						if you want to know even more about me, but here are
						some tidbits:
					</p>
					<ul className="mt-4 text-2xl list-disc list-inside">
						...
						<li>
							I tend to make things extra for even the simplest
							tasks.
						</li>
			...
			<section className="flex flex-col bg-base-100 border-b border-base-300 w-full">
				<div className="relative mx-auto mt-16 pb-16 text-left container">
					<div className="top-0 right-16 absolute flex justify-center items-center h-[calc(100%-4rem)] aspect-square text-7xl">
						...
						<span className="absolute opacity-25 rotate-12">
							灰色
						</span>
					</div>
					<h1 className="font-semibold text-6xl">
					...
					<p className="mt-4 max-w-3xl text-2xl text-justify">
						It started off as just a simple personal site. I then
						had an idea to invite a couple people into a GitHub org,
						and have them all make cool stuff together. The whole
						thing&apos;s very WIP so far, but I hope to make it a
						fun little place for others to check out.
					</p>
				</div>
			</section>
			<section className="flex flex-col border-b border-base-300 w-full">
